...
gpu.addFunction(trace_color0);
gpu.addFunction(trace_color1);
gpu.addFunction(trace_color2);
gpu.addFunction(trace_color3);
...
function render(mode) {
    ...
    // first 'unpack' the arays so gpu.js can understand
        ...
        // scale
        var xfactor = (this.thread.x * pixelWidth) - halfWidth,
            xcomp_x = vpRight_x * xfactor,
            xcomp_y = vpRight_y * xfactor,
            xcomp_z = vpRight_z * xfactor;

        // scale
        var yfactor = (this.thread.y * pixelHeight) - halfHeight,
